...
export class Project {
  ...
  constructor(
    ...
    function getTsConfigCompilerOptions() {
      if (tsConfigResolver == null) return {}
    ...
    if (typeof fileNameOrSearchFunction === 'string') {
      ...
      if (
        ...
        const errorFileNameOrPath =
          this.#fileSystemWrapper.getStandardizedAbsolutePath(fileNameOrPath)
        throw new errors.InvalidOperationError(
  ...
  #getSourceFileInternal(
    ...
    function getFilePathOrSearchFunction(
      fileSystemWrapper: TransactionalFileSystem
    ): StandardizedFilePath | ((file: ts.SourceFile) => boolean) {
      ...
      else return def => FileUtils.pathEndsWith(def.fileName, fileNameOrPath)
    }
